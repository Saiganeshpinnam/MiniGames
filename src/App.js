...
import EmojiPlayArea from './components/EmojiPlayArea'

import RockPaperScissorsHome from './components/RockPaperScissorsHome'

import RPSPlayArea from './components/RPSPlayArea'
...
const App = () => (
  <Switch>
    ...
    <Route exact path="/emoji-play-area" component={EmojiPlayArea} />
    <Route exact path="/rock-paper-scissor" component={RockPaperScissorsHome} />
